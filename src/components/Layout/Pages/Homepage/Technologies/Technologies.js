...
const DUMMY_TECHNOLOGIES = [
  {
    ...
    name: "JavaScript",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit modi illo pariatur assumenda, quis aliquid? Corrupti sint aut, soluta laboriosam sequi vitae praesentium molestias fugit et, minima dolore odio itaque.",
    icon: [
      {
        viewBox: "0 0 448 512",
        fill: "#f0db4f",
